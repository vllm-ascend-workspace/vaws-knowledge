# Ascend950PR_9599 CANN 9.0.0 platform constants

Ascend950PR_9599 declares 11 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- soc: Ascend950PR_9599, Ascend950
- cann: 9.0.0
...
- source: ref: cann-9.0.0:platform_config:Ascend950PR_9599.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 530.8416 | tflops | cube dense matmul, from declared cube shape and clock |
| bf16_dense_matmul_peak | theoretical | 530.8416 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 1061.6832 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 2123.3664 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 2008.8 | gbps | derived from the declared DDR rate in bytes per cycle |
| memory_size | declared | 128 | gib |  |
| cube_clock | declared | 1800 | mhz |  |
| ai_core_count | declared | 36 | count |  |
| cube_core_count | declared | 36 | count |  |
| vector_core_count | declared | 72 | count |  |
| memory_rate | declared | 31 | bytes_per_cycle |  |
