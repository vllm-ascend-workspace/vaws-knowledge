# Ascend910ProA CANN 9.0.0 platform constants

Ascend910ProA declares 9 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend910ProA.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 288.3584 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 576.7168 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 1153.4336 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 1126.4 | gbps | derived from the declared DDR rate in bytes per cycle |
| cube_clock | declared | 1100 | mhz |  |
