# Ascend950PR_950z CANN 9.0.0 platform constants

Ascend950PR_950z declares 11 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- soc: Ascend950PR_950z, Ascend950
- cann: 9.0.0
...
- source: ref: cann-9.0.0:platform_config:Ascend950PR_950z.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 54.0672 | tflops | cube dense matmul, from declared cube shape and clock |
| bf16_dense_matmul_peak | theoretical | 54.0672 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 108.1344 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 216.2688 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 26.4 | gbps | derived from the declared DDR rate in bytes per cycle |
| memory_size | declared | 24 | gib |  |
| cube_clock | declared | 1650 | mhz |  |
| ai_core_count | declared | 4 | count |  |
| cube_core_count | declared | 4 | count |  |
| vector_core_count | declared | 8 | count |  |
| memory_rate | declared | 4 | bytes_per_cycle |  |
