# Ascend035B CANN 9.0.0 platform constants

Ascend035B declares 7 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend035B.ini
