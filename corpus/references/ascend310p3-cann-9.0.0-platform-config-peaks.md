# Ascend310P3 CANN 9.0.0 platform constants

Ascend310P3 declares 10 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend310P3.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 69.46816 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 138.93632 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 277.87264 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 144.16 | gbps | derived from the declared DDR rate in bytes per cycle |
