# Ascend310P7 CANN 9.0.0 platform constants

Ascend310P7 declares 10 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend310P7.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 36.0448 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 72.0896 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 144.1792 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 74.8 | gbps | derived from the declared DDR rate in bytes per cycle |
| memory_size | declared | 22.352 | gib |  |
| cube_clock | declared | 550 | mhz |  |
