# Ascend910A CANN 9.0.0 platform constants

Ascend910A declares 9 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend910A.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 262.144 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 524.288 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 1048.576 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 1024 | gbps | derived from the declared DDR rate in bytes per cycle |
| cube_clock | declared | 1000 | mhz |  |
