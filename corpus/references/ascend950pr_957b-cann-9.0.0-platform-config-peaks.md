# Ascend950PR_957b CANN 9.0.0 platform constants

Ascend950PR_957b declares 11 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- soc: Ascend950PR_957b, Ascend950
- cann: 9.0.0
...
- source: ref: cann-9.0.0:platform_config:Ascend950PR_957b.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 378.4704 | tflops | cube dense matmul, from declared cube shape and clock |
| bf16_dense_matmul_peak | theoretical | 378.4704 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 756.9408 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 1513.8816 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 1247.4 | gbps | derived from the declared DDR rate in bytes per cycle |
| memory_size | declared | 112 | gib |  |
| cube_clock | declared | 1650 | mhz |  |
| ai_core_count | declared | 28 | count |  |
| cube_core_count | declared | 28 | count |  |
| vector_core_count | declared | 56 | count |  |
| memory_rate | declared | 27 | bytes_per_cycle |  |
