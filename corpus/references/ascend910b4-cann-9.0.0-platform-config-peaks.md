# Ascend910B4 CANN 9.0.0 platform constants

Ascend910B4 declares 11 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend910B4.ini
