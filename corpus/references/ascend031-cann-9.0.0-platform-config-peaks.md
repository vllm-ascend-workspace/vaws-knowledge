# Ascend031 CANN 9.0.0 platform constants

Ascend031 declares 9 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 2.70336 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 5.40672 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 10.81344 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 5.61 | gbps | derived from the declared DDR rate in bytes per cycle |
| cube_clock | declared | 330 | mhz |  |
