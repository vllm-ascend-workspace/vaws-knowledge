# Ascend310B4 CANN 9.0.0 platform constants

Ascend310B4 declares 9 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend310B4.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 4.096 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 8.192 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 16.384 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 4 | gbps | derived from the declared DDR rate in bytes per cycle |
| cube_clock | declared | 500 | mhz |  |
| ai_core_count | declared | 1 | count |  |
| cube_core_count | declared | 1 | count |  |
| vector_core_count | declared | 1 | count |  |
| memory_rate | declared | 8 | bytes_per_cycle |  |
