# Ascend910B CANN 9.0.0 platform constants

Ascend910B declares 9 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend910B.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 221.184 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 442.368 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 884.736 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 864 | gbps | derived from the declared DDR rate in bytes per cycle |
| cube_clock | declared | 900 | mhz |  |
