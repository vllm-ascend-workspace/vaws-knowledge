# Ascend910B2C CANN 9.0.0 platform constants

Ascend910B2C declares 10 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend910B2C.ini
