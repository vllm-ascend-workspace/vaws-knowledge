# Ascend910_9381 CANN 9.0.0 platform constants

Ascend910_9381 declares 11 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- soc: Ascend910_9381, Ascend910_93
- cann: 9.0.0
...
- source: ref: cann-9.0.0:platform_config:Ascend910_9381.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 353.8944 | tflops | cube dense matmul, from declared cube shape and clock |
| bf16_dense_matmul_peak | theoretical | 353.8944 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 707.7888 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 1415.5776 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 1382.4 | gbps | derived from the declared DDR rate in bytes per cycle |
| memory_size | declared | 64 | gib |  |
| cube_clock | declared | 1800 | mhz |  |
| ai_core_count | declared | 24 | count |  |
| cube_core_count | declared | 24 | count |  |
| vector_core_count | declared | 48 | count |  |
