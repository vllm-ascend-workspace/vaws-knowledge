# Ascend910_9372 CANN 9.0.0 platform constants

Ascend910_9372 declares 11 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- soc: Ascend910_9372, Ascend910_93
- cann: 9.0.0
...
- source: ref: cann-9.0.0:platform_config:Ascend910_9372.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 294.912 | tflops | cube dense matmul, from declared cube shape and clock |
| bf16_dense_matmul_peak | theoretical | 294.912 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 589.824 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 1179.648 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 1152 | gbps | derived from the declared DDR rate in bytes per cycle |
