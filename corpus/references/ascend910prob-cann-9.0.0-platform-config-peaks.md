# Ascend910ProB CANN 9.0.0 platform constants

Ascend910ProB declares 9 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 282.624 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 565.248 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 1130.496 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 1104 | gbps | derived from the declared DDR rate in bytes per cycle |
| cube_clock | declared | 1150 | mhz |  |
| ai_core_count | declared | 30 | count |  |
| cube_core_count | declared | 30 | count |  |
