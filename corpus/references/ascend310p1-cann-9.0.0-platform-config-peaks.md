# Ascend310P1 CANN 9.0.0 platform constants

Ascend310P1 declares 10 platform constants in CANN 9.0.0 platform_config, including its theoretical dense matmul peaks
...
- source: ref: cann-9.0.0:platform_config:Ascend310P1.ini
...
|---|---|---|---|---|
| fp16_dense_matmul_peak | theoretical | 86.8352 | tflops | cube dense matmul, from declared cube shape and clock |
| int8_dense_matmul_peak | theoretical | 173.6704 | tops | cube dense matmul, from declared cube shape and clock |
| int4_dense_matmul_peak | theoretical | 347.3408 | tops | cube dense matmul, from declared cube shape and clock |
| memory_bandwidth_peak | theoretical | 180.2 | gbps | derived from the declared DDR rate in bytes per cycle |
| memory_size | declared | 22.352 | gib |  |
| cube_clock | declared | 1060 | mhz |  |
| ai_core_count | declared | 10 | count |  |
| cube_core_count | declared | 10 | count |  |
