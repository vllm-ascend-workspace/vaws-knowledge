...
2. Checks the schema cannot express well:
   ...
   - ``content_hash`` equals the recomputation from ``vaws_knowledge.canonical``.
...
def main(argv: list[str]) -> int:
    ...
    parser.add_argument("--schema", type=Path, default=None, help="schema file (default: packaged knowledge-v2.schema.json)")
