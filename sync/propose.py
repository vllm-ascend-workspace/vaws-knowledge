...
def render_pr_body(proposal: Proposal) -> str:
    plan = proposal.plan
    lines = [
        ...
        "export. New entries land in `corpus/unverified/`; nothing here touches",
        "`corpus/verified/`.",
        "",
    ...
    *,
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="vaws-sync-aux-") as aux:
            ...
            body_path.write_text(render_pr_body(proposal), encoding="utf-8")
            proc = _run(
                runner,
