...
YAML_MISSING_HINT = (
    ...
    "Install it with: python3 -m pip install -r server/requirements.txt "
...
def repo_root() -> Path:
    """Root of the checkout this module was loaded from."""

    return Path(__file__).resolve().parent.parent


def default_shared_roots() -> tuple[Path, ...]:
    return (repo_root() / "corpus" / "verified",)
